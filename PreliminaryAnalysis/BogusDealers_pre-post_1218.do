...
merge m:1 DealerTIN using "F:\java_results\network_parameters_quarter_9.dta"

keep if TaxPeriod=="First Quarter-2012"
tab TaxPeriod BogusDummy
tab _merge
tab TaxPeriod BogusDummy if _merge==3
keep if _merge==3
sum MoneyDeposited, detail
sum MoneyDeposited if BogusDummy==1, detail
sum MoneyDeposited if BogusDummy==0, detail
sum MoneyDeposited, detail
sum MoneyDeposited if BogusDummy==0, detail
sum MoneyDeposited if BogusDummy==1, detail
sum MoneyDeposited TurnoverGross  if BogusDummy==1, detail
sum MoneyDeposited TurnoverGross  if BogusDummy==0, detail
sum MoneyDeposited TurnoverGross  if BogusDummy==0, detail
tab network_number
tab modularityclass


sum InDegree_gephi OutDegree_gephi degree clusteringcoefficient eigenvectorcentrality eccentricity closenesscentrality betweennesscentrality self_loop TurnoverGross MoneyDeposited if BogusDummy==1
sum InDegree_gephi OutDegree_gephi degree clusteringcoefficient eigenvectorcentrality eccentricity closenesscentrality betweennesscentrality self_loop TurnoverGross MoneyDeposited if BogusDummy==0


sum InDegree_gephi OutDegree_gephi degree clusteringcoefficient eigenvectorcentrality eccentricity closenesscentrality betweennesscentrality self_loop TurnoverGross MoneyDeposited if BogusDummy==0&modularityclass==21
sum InDegree_gephi OutDegree_gephi degree clusteringcoefficient eigenvectorcentrality eccentricity closenesscentrality betweennesscentrality self_loop TurnoverGross MoneyDeposited if BogusDummy==1&modularityclass==21
