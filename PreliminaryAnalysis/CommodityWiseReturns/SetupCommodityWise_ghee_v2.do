...
/* Then I will do analysis only on those dealers which traded only in ghee*/
use "PreliminaryAnalysis\returns\form16_data_v3_0901.dta", clear
merge m:1 DealerTIN using "PreliminaryAnalysis\CommodityWiseReturns\dealers_onlyghee.dta", keepusing(CommodityCode CommodityDescription GheeDummy CommodityTaxRate)
keep if _merge==3

/*Aggregate analysis time wise, not at the dealer level*/
{

/* Drop all the top dealers as they deal in many more commodities*/
drop if DealerTIN=="262863"|DealerTIN=="400083"|DealerTIN=="218187"|DealerTIN=="428550"|DealerTIN=="326992"|DealerTIN=="315900"
...
save "PreliminaryAnalysis\CommodityWiseReturns\form16_aggregate_annual_v4_1013_ghee_final.dta"
restore
...
gen CommodityCode="110000"
save "PreliminaryAnalysis\CommodityWiseReturns\form16_aggregate_quarterly_v4_1013_ghee_final.dta", replace
restore


//Looking at quarter wise graphs
twoway (connected TurnoverGross TaxQuarter, yaxis(2)) (connected TurnoverLocal TaxQuarter, yaxis(2)) (connected TurnoverCentral TaxQuarter, yaxis(2)) (connected MoneyDeposited TaxQuarter), xline(13, lcolor(green) extend)
...
//How to find dealers who only deal in ghee
use "D:\data\PreliminaryAnalysis\CommodityWiseReturns\TableCommodityCodes_unique_v2_0930.dta", clear
gen dummy=.
replace dummy=1 if CommodityCode=="110000"
...
tab CommodityCount if dummy==1
br DealerTIN CommodityCode CommodityCount if CommodityCount==1
...
save "PreliminaryAnalysis\CommodityWiseReturns\dealers_onlyghee.dta"
