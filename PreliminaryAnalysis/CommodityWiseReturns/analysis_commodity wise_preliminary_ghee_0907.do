...
use "D:\data\preliminary analysis\returns\form16_data_v3_0901.dta", clear
...
save "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal.dta"
...
save "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_annual.dta"
//We create a table for half yearly return filings
use "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal.dta", clear
...
save "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_halfyearly.dta"
...
save "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_quarterly.dta"
...
save "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_monthly.dta", replace

//Now we do aggregations

//First at the annual level
use "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_annual.dta", clear
...
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_v3_0907_ghee.dta"

//THen we use the semi-annual returns
use "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_halfyearly.dta", clear
collapse (sum) RefundClaimed DieselSale InterStateSaleCD InterStatePurchaseCD InterStateSaleCE1E2 InterStatePurchaseCE1E2 PurchaseExemptedGoodsCST SaleExemptedGoodsCST PurchaseExemptedGoodsSchedule SaleExemptedGoodsSchedule TurnoverGross TurnoverCentral TurnoverLocal TurnoverAt1 OutputTaxAt1 TurnoverAt5 OutputTaxAt5 TurnoverAt125 OutputTaxAt125 TurnoverAt20 OutputTaxAt20 WCTurnoverAt5 WCOutputTaxAt5 WCTurnoverAt125 WCOutputTaxAt125 ExemptedSales PurchaseOtherGoods OutputTaxBeforeAdjustment AdjustmentOutputTax TotalOutputTax PurchaseCapitalGoods CreditCapitalGoods CreditGoodsAt1 PurchaseGoodsAt5 CreditGoodsAt5 PurchaseGoodsAt125 CreditGoodsAt125 PurchaseGoodsAt20 CreditGoodsAt20 WCPurchaseAt5 WCCreditAt5 WCPurchaseAt125 WCCreditAt125 CreditOtherGoods TaxCreditBeforeAdjustment AdjustmentTaxCredit TotalTaxCredit NetTax InterestPayable PenaltyPayable BalancePayable AmountDepositedByDealer AggregateAmountPaid NetBalance BalanceBroughtForward AdjustCSTLiability BalanceCarriedNextTaxPeriod InterStateExportsAgainstH InterStateImportsAgainstH InterStateExportsAgainstI InterStateImportsAgainstI InterStateExportsAgainstJ InterStateImportsAgainstJ ExportFromIndia ImportToIndia InterStateSaleOther InterStatePurchaseOther InterStateSaleCapital InterStatePurchaseCapital TotalInterStateSale TotalInterStatePurchase PurchaseUnregisteredDealer PurchaseCompositionDealer PurchaseNonCreditableGoods PurchaseRetailInvoice PurchaseTaxFreeGoods DieselPurchase PurchaseIneligibleForITC PurchaseDelhiFormH PurchaseCapitalNonCreditGood CarryForwardTaxCredit CSTAdjustmentVAT HighSeaSale HighSeaPurchase, by(year) fast
gen SourceFile="Half Yearly Returns"
gen CommodityCode="110000"
append using "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_v3_0907_ghee.dta"
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_v3_0907_ghee.dta", replace

//Then we use the quarterly returns
//Now we will aggregate both at the quarterly and the annual level
use "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_quarterly.dta", clear
...
gen SourceFile="Quarterly Returns"
gen CommodityCode="110000"
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_v3_0907_ghee.dta"


//Finally we use the monthly returns
use "D:\data\preliminary analysis\commodity wise returns\form16_data_v3_0901_onlyghee_internal_monthly.dta", clear
...
gen SourceFile="Monthly Returns"
gen CommodityCode="110000"
append using "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_v3_0907_ghee.dta"
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_v3_0907_ghee.dta", replace

//Now we add all the returns at the annual level
use "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_v3_0907_ghee.dta", clear
...
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_final_0907_ghee.dta", replace

//Now we add all the returns at the Quarterly level
use "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_v3_0907_ghee.dta", clear
...
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_final_0907_ghee.dta", replace

use "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_final_laterhalf_commoditywise.dta", clear
keep if CommodityCode==110000
tostring CommodityCode, replace
append using "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_final_0907_ghee.dta"
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_quarter_final_0907_ghee_including_laterhalf.dta"

twoway (connected TurnoverGross quarter, yaxis(2)) (connected TurnoverLocal quarter, yaxis(2)) (connected TurnoverCentral quarter, yaxis(2)) (connected AggregateAmountPaid quarter), xline(11, lcolor(green) extend)
...
append using "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_final_0907_ghee.dta"
...
save "D:\data\preliminary analysis\commodity wise returns\form16_aggregate_annual_final_0907_ghee_including laterhalf.dta"
